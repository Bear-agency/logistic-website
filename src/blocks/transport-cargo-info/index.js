...
export function TransportCargoInfo() {
  ...
  return (
    <div>
      <p style={styles.title}>Информация о транспорте</p>
      <p style={styles.subtitle}>
        Укажите как можно подробнее доступную информацию о транспорте
      </p>
      ...
      <div style={styles.grid}>
        ...
        <div>
          ...
          <label style={styles.fieldLabel}>Тип транспорта</label>
          <DropdownMenu
        ...
        <div>
         ...
         <InputField
          ...
          <div style={styles.marginBlock}>
           <label style={styles.fieldLabel}>Висота груза</label>
          <InputField
            value={quantity}
            onChange={e => setQuantity(e.target.value)}
            placeholder="Укажите висоту"
            {...styles.fullWidth}
          />
          </div>
        </div>
